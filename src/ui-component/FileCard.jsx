...
export default function FileCard() {
  return (
    ...
    >
      ...
      >
        <Avatar src="src/assets/images/users/1.jpg" size="lg" />
        <AvatarGroup size="sm" sx={{ '--Avatar-size': '28px' }}>
          <Avatar src="src/assets/images/users/2.jpg" />
          <Avatar src="src/assets/images/users/3.jpg" />
          <Avatar src="src/assets/images/users/4.jpg" />
          <Avatar>+4K</Avatar>
        </AvatarGroup>
      </Box>
      <CardContent>
